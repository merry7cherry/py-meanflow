...
# Original license: https://github.com/NVlabs/edm/blob/main/LICENSE.txt
# Modified for MeanFlow project
...
#----------------------------------------------------------------------------
# EDM UNet's AttentionOp does not support compilation. Use FM UNet's instead.
...
class UNetBlock(torch.nn.Module):
    ...
    def forward(self, x, emb):
        ...
        if self.num_heads:
            """ EDM UNet's Attention does not support compilation. Use FM UNet's instead. """
